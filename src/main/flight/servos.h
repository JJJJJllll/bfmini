...
typedef enum {
    ...
    SERVO_BICOPTER_LEFT_ELEVON = 6,
    SERVO_BICOPTER_RIGHT_ELEVON = 7,
#endif
  // 20250324 mixerBI, adding QUADTILT mixer
#ifdef CONFIGURATION_QUADTILT
    SERVO_BICOPTER_LEFT_REAR = 6,
    SERVO_BICOPTER_RIGHT_REAR = 7,
#endif
